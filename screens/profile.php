<div class="row">
    <div class="col-12 col-md-4 shadow-sm m-3">
        <h3 align="center" class="text-dark text-uppercase" id="name"></h3>
        <hr>
    ...
    <div class="col shadow-sm m-3">
        <h5 class="card-header">Articles de <span class="text-uppercase" id="nameb"></span></h5>
